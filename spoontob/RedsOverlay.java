...
public class RedsOverlay extends Overlay {
    @Inject
    ...
    public Dimension render(Graphics2D graphics) {
        if (this.config.redsTL() != SpoonTobConfig.redsTlMode.OFF && this.plugin.enforceRegion())
            for (NPC reds : this.client.getNpcs()) {
                if (reds.getName() != null && reds.getName().equalsIgnoreCase("nylocas matomenos")) {
                    ...
                    if (lp != null) {
                        ...
                        if (tilePoly != null && (((this.config
                                .redsTL() == SpoonTobConfig.redsTlMode.MAIDEN || this.config.redsTL() == SpoonTobConfig.redsTlMode.BOTH) && TheatreRegions.inRegion(this.client, TheatreRegions.MAIDEN)) || ((this.config
                                .redsTL() == SpoonTobConfig.redsTlMode.VERZIK || this.config.redsTL() == SpoonTobConfig.redsTlMode.BOTH) && TheatreRegions.inRegion(this.client, TheatreRegions.VERZIK))))
