...
public class CustomGameObject {
    ...
    public void setFaceColorValues(Color color) {
        ...
        if (model != null && color != null) {
            ...
            if (isFaceColorsNullOrEmpty(new int[][] { this.oldColors1, this.oldColors2, this.oldColors3 })) {
                this.oldColors1 = (int[])colors1.clone();
                this.oldColors2 = (int[])colors2.clone();
                this.oldColors3 = (int[])colors3.clone();
            }
            replaceFaceColors123(color, new int[][] { colors1, colors2, colors3 });
        }
    }
    ...
    public void restore() {
        Model model = this.obj.getRenderable().getModel();
        if (model != null && !isFaceColorsNullOrEmpty(new int[][] { this.oldColors1, this.oldColors2, this.oldColors3 })) {
